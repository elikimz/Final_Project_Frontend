...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-grow flex items-center justify-center bg-gradient-to-r from-blue-500 to-green-500">
        <div className="bg-white bg-opacity-75 p-10 rounded-lg shadow-lg max-w-xl mx-auto">
